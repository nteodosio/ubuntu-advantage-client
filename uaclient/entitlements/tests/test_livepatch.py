...
class TestUALivepatchClient:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ([({"Supported": "yes"}, None)], True),
            ([({"Supported": "no"}, None)], False),
            ([({}, None)], False),
            ([([], None)], None),
            ([("string", None)], None),
...
class TestOnSupportedKernel:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                [
                    (
                        '{"Status": [{"Livepatch": {"Supported": "supported"}}]}',  # noqa: E501
                        None,
                    )
                ],
                True,
            ...
            (
                ...
                [
                    (
                        '{"Status": [{"Livepatch": {"Supported": "unsupported"}}]}',  # noqa: E501
                        None,
                    )
                ],
                False,
            ...
            (
                ...
                [
                    (
                        '{"Status": [{"Livepatch": {"Supported": "unknown"}}]}',  # noqa: E501
                        None,
                    )
                ],
                None,
            ...
            (
                ...
                [
                    (
                        '{"Status": [{"Livepatch": {"Supported": "unknown", "State": "unknown"}}]}',  # noqa: E501
                        None,
                    )
                ],
                None,
            ...
            (
                ...
                [
                    (
                        '{"Status": [{"Livepatch": {"Supported": "unknown", "State": "applied"}}]}',  # noqa: E501
                        None,
                    )
                ],
                True,
    ...
    @mock.patch(M_PATH + "LIVEPATCH_SUPPORT_CACHE.read")
    ...
    @mock.patch(M_PATH + "LIVEPATCH_SUPPORT_CACHE.write")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                (True, True),
                None,
                [mock.call("5.6-7", "generic", "x86_64", "xenial")],
                [],
                True,
            ),
            # cache result false
    ...
    def test_on_supported_kernel(
        ...
        m_get_lscpu_arch.return_value = get_lscpu_arch_result
